...
<html lang="en">
  ...
  <body id="home">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info shadow-sm fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">aditmaulana</a>
    ...
    <section class="jumbotron text-center">
      ...
      <p class="lead"><?= $pro['jabatan'];?>|<?= $pro['peerusahaan'];?></p>
...
<div class="row justify-content-center">
  <?php foreach($data['project'] as $pro):?>    
         <div class="col-md-4 mb-3">
          <div class="card">
          <img src="<?= baseurl;?>/asset/img/<?= $pro['foto'];?>" class="card-img-top" alt="project" height="400px" width="500px">
          <div class="card-body">
            <h3><?= $pro['nama_p'];?></h3>
...
<!-- Footer -->
    ...
    white text-center pb-4">
      <p>Creater with <i class="bi bi-suit-heart-fill text-danger"></i> by <a href="https:/www.instagram.com/vinaaatae_"class="text-white fw-bold">adit</a></p>
